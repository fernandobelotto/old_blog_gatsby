  ...
  return (
    <>
      <Layout pageTitle={t("About")} subTitle={t("Who is Fernando Belotto?")}>
        <CustomImage
          imageUrl={`https://images.unsplash.com/photo-1525547719571-a2d4ac8945e2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1064&q=80`}
        />
        ...
        <Text fontSize={"2xl"}>
          {t("That I find amazing and love to work with")}
        </Text>
        <TechList mt="4" />
      </Layout>
    </>
