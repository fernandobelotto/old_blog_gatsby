        ...
        resources: {
            en: {
                translation: {
                    ...
                    "If you want to checkout my writing, head up to the blog's page": "If you want to checkout my writing, head up to the blog's page",
                    'In case you want to see some open source code, go to the projects page': 'In case you want to see some open source code, go to the projects page',
                    'To know about me and my history, the about page is the place': 'To know about me and my history, the about page is the place',
                    'Finally, see how to reach me at the  contact page': 'Finally, see how to reach me at the  contact page',
            },
        },
            br: {
                translation: {
                    ...
                    "If you want to checkout my writing, head up to the blog's page": "Se você quiser verificar meus artigos, vá até a página do blog",
                    'In case you want to see some open source code, go to the projects page': 'Caso você deseja ver algum código-fonte aberto, vá para a página "projetos"',
                    'To know about me and my history, the about page is the place': 'Para saber sobre mim e minha história, a página "sobre" é o lugar',
                    'Finally, see how to reach me at the  contact page': 'Finalmente, você pode falar ver como me contatar na página "contato"',
                }
            },
            es: {
                translation: {
                    ...
                    "Your Email": "Su email",
                    "Your Message": "Su mesage",
                    "If you want to checkout my writing, head up to the blog's page": 'Si quieres revisar mi artículos, ve a la página del blog.',
                    'In case you want to see some open source code, go to the projects page': 'En caso de que desee ver algún código de código abierto, vaya a la página de Proyectos.',
                    'To know about me and my history, the about page is the place': 'Para saber sobre mí y mi historia, la página sobre la página es el lugar.',
                    'Finally, see how to reach me at the  contact page': 'Finalmente, vea cómo llegar a la página de contacto.',
                }
            },
        },
        lng: "en",
