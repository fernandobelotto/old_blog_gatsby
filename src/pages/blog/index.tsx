...
function BlogCard({ post }) {
    return (
        <Box p='5' cursor={'pointer'} textDecor={'none'} borderRadius='2xl' shadow={'sm'} border={'1px solid'} borderColor='gray.200' onClick={() => { }} transition="all 0.25s" transition-timing-function="spring(1 100 10 10)" _hover={{
